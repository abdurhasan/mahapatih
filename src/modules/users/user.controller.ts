...
export class UserController {
  ...
  @Public()
  @Post('register')
  async register(@Body() param: UserRegisterInput) {
    try {
      return response({
  ...
  @Public()
  @Post('login')
  async login(@Body() param: UserLoginInput) {
    try {
      return response({
  ...
  @Public()
  @Post('voucher/:days')
  async createVoucher(@Param('days') days: number) {
    try {
  ...
  async getCustomerServices(
    ...
    try {
      return response({
        result: await this.service.getCustomerServices(paginationParam, user),
      });
    } catch (e) {
      return responseError(e?.message);
    }
